...
enum EnumMethodology: String {
    ...
    case descriptionFour = "Você deverá poupar uma quantia semanalmente, enquanto os valores aumentam progressivamente."
    case exampleFour = "Ex.: Se na primeira semana você poupar R$5, na semana seguinte deverá guardar R$10, e R$15 na terceira semana. Repitindo esse processo por 52 semanas, você acumula R$1755."
    
    case imageFive = "52weeksGraphImage"
    case titleFive = "Vale a pena?"
    case descriptionFive = "Uma das maiores vantagens desse método é que não é necessário se ter uma quantia muito alta, basta iniciar com quanto quiser."
    case exampleFive = "Ex.: Se quiser começar guardando o valor de R$1, seu valor no final de um ano será de R$1378."
}
